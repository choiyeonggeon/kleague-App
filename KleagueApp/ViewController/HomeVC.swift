...
class HomeVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .lightGrayBG
        setupCollectionView()
        setupUI()
        title = "홈"
    ...
    private func setupCollectionView() {
        let layout = UICollectionViewCompositionalLayout { sectionIndex, _ in
            ...
            group.interItemSpacing = .fixed(20) // ✅ 안전하게 간격 설정
...
extension UIColor {
    static let grassGreen = UIColor(hex: "#2E7D32")
    static let navy = UIColor(hex: "#0D1B2A")
    static let lightGrayBG = UIColor(hex: "#F6F7F9")
}
